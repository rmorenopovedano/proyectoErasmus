...
class RokSprocket_Provider_FieldsAttach_Filter_Type_User extends RokCommon_Filter_Type
{
	...
	protected function getInput($name = RokCommon_Filter_Type::JAVASCRIPT_NAME_VARIABLE, $value = '')
	{
		...
		$link	  = 'login.php?option=com_users&amp;view=users&amp;layout=modal&amp;tmpl=component&amp;field=Sprocket' . (isset($groups) ? ('&amp;groups=' . base64_encode(json_encode($groups))) : '') . (isset($excluded) ? ('&amp;excluded=' . base64_encode(json_encode($excluded))) : '');
