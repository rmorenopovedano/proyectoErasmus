...
class RokSprocket_Provider_EasyBlog_Filter_Type_Article extends RokSprocket_Provider_Filter_Type_AbstractArticle
{
	...
	protected function getInput($name = RokCommon_Filter_Type::JAVASCRIPT_NAME_VARIABLE, $value = '')
	{
		...
		$html = array();
        $link = 'login.php?option=com_easyblog&amp;view=blogs&amp;tmpl=component&amp;browse=1&amp;browsefunction=jSelectUser_Sprocket';
		//$link = 'login.php?option=com_roksprocket&amp;view=easyblogitems&amp;layout=model&amp;tmpl=component&amp;function=jSelectUser_Sprocket';
