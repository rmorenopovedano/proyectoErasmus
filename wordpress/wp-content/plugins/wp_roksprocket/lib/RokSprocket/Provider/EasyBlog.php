...
/*
		...
		$primary_link->setUrl(EasyBlogRouter::_('login.php?option=com_easyblog&view=entry&id=' . $raw_item->id . '&Itemid=' . $itemId ));
		...
		$link->setUrl(EasyBlogRouter::_('login.php?option=com_easyblog&view=entry&id=' . $raw_item->id . '&Itemid=' . $itemId ));
		$link->setText('');
	...
	{
		// return JURI::root(true) . '/administrator/login.php?option=com_easyblog&c=blogs&task=edit&blogid=' . $id;
		return JURI::root(true) . '/administrator/login.php?option=com_easyblog&view=composer&tmpl=component&uid=' . $id;
	}
