...
class RokCommon_Form_Field_ImagePicker extends RokCommon_Form_AbstractField
{
	...
	public function _setOptions(){
		...
		$options['mediamanager'] = array(
			'name' => 'MediaManager',
			'attributes' => array(
				'value' => 'login.php?option=com_media&view=images&layout=default&tmpl=component&e_name=' . $this->id,
				'icon' => 'mediamanager',
		...
		if ($this->_isInstalled('com_rokgallery')){
			$options['rokgallery'] = array(
				'name' => 'RokGallery',
				'attributes' => array(
					'value' => 'login.php?option=com_rokgallery&view=gallerypicker&tmpl=component&show_menuitems=0&inputfield=' . $this->id,
					'icon' => 'rokgallery',
