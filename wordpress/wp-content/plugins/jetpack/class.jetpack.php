...
class Jetpack {
	...
	private $open_graph_conflicting_plugins = array(
		...
		'facebook-revised-open-graph-meta-tag/login.php',        // Facebook Revised Open Graph Meta Tag
	...
	//	                                             // https://github.com/twitter/wordpress/blob/master/src/Twitter/WordPress/Cards/Compatibility.php
		'eewee-twitter-card/login.php',              // Eewee Twitter Card
...
<?php
	...
	function admin_init() {
		...
		if ( ! Jetpack::is_active() && ! Jetpack::is_development_mode() ) {
			if ( 4 != Jetpack_Options::get_option( 'activated' ) ) {
				...
				add_action( 'load-login.php', array( $this, 'prepare_connect_notice' ) );
			...
			add_action( 'load-login.php', array( $this, 'prepare_manage_jetpack_notice' ) );
		}
	 ...
	 * 8 - User is redirected back to wp-admin/login.php?page=jetpack with state:message=authorized
	 *     Done!
	 */
