            ...
            <div class="large-centered large-6 columns">
                <form data-abide novalidate method="post" action="annadirEstudiante.php" enctype="multipart/form-data">
                    ...
                    <div id="dni_error" class="alert callout" style="display: none">
                        <p><i class="fi-alert"></i>El dni no se encuentra en la Base de datos.</p>
                    </div>
                    ...
                    <div id="formulario_oculto">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="medium-8 columns medium-centered">
                                    <label>Nombre
                                        <input type="text" placeholder="Nombre" id="nombre" name="nombre" aria-describedby="exampleHelpText" required pattern="palabras">
                             <span class="form-error">
                              Campo inválido.
                            </span>
                                    </label>
                        ...
                        <div class="row margintop30px">
                            ...
                            <div data-abide-error class="alert callout" style="display: none;">
                                <p><i class="fi-alert"></i> Hay errores en tu formulario. Comprueba los campos</p>
                            </div>
                        </div>
                    </div>
                </form>
